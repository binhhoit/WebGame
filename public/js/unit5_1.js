...
function create() {
	...
	banana2 = game.add.button(BANANA_7_POSX, BANANA_7_POSY, 'banana');
	banana3 = game.add.button(BANANA_6_POSX, BANANA_6_POSY, 'banana');
	banana4 = game.add.button(BANANA_5_POSX, BANANA_5_POSY, 'banana');
